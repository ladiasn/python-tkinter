...
img = ImageTk.PhotoImage(Image.open('header2.jpg'))

lb1 = Label(root, image=img)
...
button_reset = Button(root, text='New Game', bg='darkcyan', padx=8, pady=6, command=reset, font=('Comic Sans',15))
